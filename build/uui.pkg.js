...
uui.Form = function(o) {
    ...
    var f = {
        ...
        if ("#" != a.charAt(1)) return f[a] || a;
        var b;
        return b = a.charAt(2), "x" == b || "X" == b ? (b = a.substring(3, a.length - 1), 
        b = parseInt(b, 16)) : (b = a.substring(2, a.length - 1), b = parseInt(b)), isNaN(b) ? a : String.fromCharCode(b);
    }, c = function(a) {
        return a.replace(/&/g, "&amp;").replace(/"/g, "&quot;").replace(/'/g, "&#39;").replace(/</g, "&lt;").replace(/>/g, "&gt;");
    }, e = function(a) {
        return a.replace(/&#?\w+;/g, g);
    };
    "undefined" != typeof module ? (c.htmlEncode = c, c.htmlDecode = e, module.exports = c) : d && (d.htmlEncode = c, 
    d.htmlDecode = e);
}(this);